...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('event_event', (
            ...
            ('refer', self.gf('django.db.models.fields.URLField')(max_length=200)),
        ...
        db.create_table('event_message', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('msg_from', self.gf('django.db.models.fields.related.ForeignKey')(related_name='msg_from', to=orm['accounts.UserProfile'])),
            ('msg_to', self.gf('django.db.models.fields.related.ForeignKey')(related_name='msg_to', to=orm['accounts.UserProfile'])),
            ('content', self.gf('django.db.models.fields.TextField')()),
            ('time', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('is_read', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('event', ['Message'])
